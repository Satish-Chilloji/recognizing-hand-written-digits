...
if __name__=='__main__':
    ...
    test_size=0.1
    dev_size=0.1
    X_train,Y_train, X_dev, Y_dev, X_test, Y_test=train_dev_test_split(X,y,test_size,dev_size)
    print(f'The number of total samples in the dataset (train + test + dev) is : {len(X_train)+len(X_dev)+len(X_test)}')
    print(f'Size of the data is {X.shape}')
